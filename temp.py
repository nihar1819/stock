...
url_list = ['http://www.moneycontrol.com/company-article/{}/news/{}#{}'.format(k, v, v) for k, v in
            companies.iteritems()]
print url_list
...
reader = csv.reader(open(r'./dict.csv', 'r'))
...
for selected_links in unique_links:
    ...
    try:
        ...
        results = urllib2.urlopen(results_url)
        results = results.read()
        results_text = BeautifulSoup(results,"html.parser")
